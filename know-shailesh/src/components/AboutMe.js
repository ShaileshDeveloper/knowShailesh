      ...
      <div className={darkMode ? "about__me__details__dark" : "about__me__details"}>
        <div className="about__me__text__container">
          <div className="about__me__text">
            <p style={{color : darkMode ? "#767579" : ""  }} className="heading__text__about">A bit about me</p>
            <p style={{color : darkMode ? "#767579" : "black"  }} className={darkMode ?  "about__me__sub__text__dark" : "about__me__sub__text"}>
            ...
            <p style={{color : darkMode ? "#767579" : ""  }}  className={darkMode ?  "about__me__sub__text__dark" : "about__me__sub__text"}>
              I have{" "}
